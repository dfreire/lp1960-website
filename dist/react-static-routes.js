...
const universalOptions = {
  ...
  const t_0 = universal(import('../src/pages/Home.jsx'), universalOptions)
const t_1 = universal(import('../src/pages/Intro.jsx'), universalOptions)
const t_2 = universal(import('../src/pages/Images.jsx'), universalOptions)
const t_3 = universal(import('../src/pages/Contacto.jsx'), universalOptions)
const t_4 = universal(import('../src/pages/404.jsx'), universalOptions)
