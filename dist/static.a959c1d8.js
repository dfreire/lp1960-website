...
/******/ 	__webpack_require__.p = "http://localhost:3050/";
/******/
...
exports.default = function (props) {
  return _react2.default.createElement(_reactStatic.Redirect, { to: '/intro' });
};
...
var md = __webpack_require__(7)('commonmark');

exports.default = (0, _reactStatic.withSiteData)((0, _reactStatic.withRouteData)(function (props) {
	return _react2.default.createElement(
		'div',
		{ className: classes.container },
		_react2.default.createElement('div', { className: classes.content, dangerouslySetInnerHTML: { __html: md.render(props.text) } })
	);
}));
...
var Images = function (_React$Component) {
	...
	function Images() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Images.__proto__ || Object.getPrototypeOf(Images)).call.apply(_ref, [this].concat(args))), _this), _this.intervalRef = undefined, _this.state = {
			marginTop: 0,
			imgWidth: 0,
			imgHeight: 0,
			visibleIndex: 0,
		...
		}, _this.autoNextImage = function () {
			_this.intervalRef = setInterval(function () {
				var sinceLastChange = Date.now() - _this.state.lastChangeTimestamp;
			...
			if (images.length > 1) {
				_this.setVisibleIndex(_this.nextIndex());
			}
			...
			if (images.length > 1) {
				_this.setVisibleIndex(_this.prevIndex());
			}
		}, _this.setVisibleIndex = function (visibleIndex) {
			_this.setState({ fadeClassName: 'fadeOut' });
			setTimeout(function () {
				_this.setState({
	...
	_createClass(Images, [{
		...
		value: function render() {
			...
			var _state = this.state,
			    ...
			    visibleIndex = _state.visibleIndex,
			    fadeClassName = _state.fadeClassName;

			var imageClassName = images.length > 1 ? 'cursor-pointer' : 'cursor-auto';
			var image = images[visibleIndex];
			var nextImage = images[this.nextIndex()];
			var prevImage = images[this.prevIndex()];

			return _react2.default.createElement(
				'div',
				{ className: classes.container, style: { marginTop: marginTop, height: imgHeight + MARGIN_Y } },
				...
				_react2.default.createElement('img', { style: { display: 'none' }, src: nextImage.src + ('?w=' + 800 + '&h=' + 800), alt: '' }),
				_react2.default.createElement('img', { style: { display: 'none' }, src: prevImage.src + ('?w=' + 800 + '&h=' + 800), alt: '' })
			);
		}
	}, {
		...
		value: function componentDidMount() {
			if (typeof document !== 'undefined') {
				var maxHeight = window.innerHeight - MARGIN_Y - MARGIN_Y;
				var imgHeight = Math.min(maxHeight, 800);
				var marginTop = Math.floor((maxHeight - imgHeight) / 2);
				var maxWidth = window.innerWidth;
				var imgWidth = Math.min(maxWidth, 800);
				// console.log('winHeight', window.innerHeight);
				// console.log('maxHeight', maxHeight);
				// console.log('marginTop', marginTop);
				// console.log('imgHeight', imgHeight);
				// console.log('imgWidth', imgWidth);
				this.setState({ marginTop: marginTop, imgHeight: imgHeight, imgWidth: imgWidth });
			}
...
exports.default = (0, _reactStatic.withSiteData)((0, _reactStatic.withRouteData)(Images));
...
exports.default = (0, _reactStatic.withSiteData)((0, _reactStatic.withRouteData)(function (props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(P, { text: props.address_line1 }),
			_react2.default.createElement(P, { text: props.address_line2 }),
			_react2.default.createElement(P, { text: props.address_line3 }),
			_react2.default.createElement(P, { text: props.address_line4 }),
			...
			_react2.default.createElement(P, { text: props.phone1 }),
			_react2.default.createElement(P, { text: props.phone2 }),
			_react2.default.createElement(P, { text: props.phone3 }),
			_react2.default.createElement('br', null),
			_react2.default.createElement(
				'h3',
				{ className: classes.h },
			...
			_react2.default.createElement(Email, { email: props.email1 }),
			_react2.default.createElement(Email, { email: props.email2 }),
			_react2.default.createElement('br', null)
		)
	);
}));
...
var P = function P(props) {
	return props.text != null && props.text.length > 0 && _react2.default.createElement(
		'p',
		{ className: classes.p },
		props.text
	);
...
var Email = function Email(props) {
	return props.email != null && props.email.length > 0 && _react2.default.createElement(
		'p',
		{ className: classes.p },
		_react2.default.createElement(
			'a',
...
var App = function App() {
	return _react2.default.createElement(
		_reactStatic.Router,
		null,
		_react2.default.createElement(AppContent, null)
	);
};

var AppContent = (0, _reactStatic.withRouter)((0, _reactStatic.withSiteData)(function (props) {
	var links = props.links;
	links.forEach(function (link) {
		return link.className = props.location.pathname.startsWith(link.to) ? classes.navLinkActive : classes.navLink;
	});
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'div',
			{ className: classes.headerBlock1 },
			_react2.default.createElement(
				'div',
				{ className: classes.headerBlock2 },
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						links.map(function (link) {
							return _react2.default.createElement(
								'li',
								{ key: link.name, className: classes.navItem },
								_react2.default.createElement(
									_reactStatic.Link,
									{ className: link.className, to: link.to },
									link.name
								)
							);
						})
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/dariofreire/MyDir/projs/diskettes/lp1960-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 5)), (0, _importCss3.default)('src/pages/Home.jsx', {
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/Home.jsx');
  },
...
var t_1 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/pages/Intro.jsx',
  file: '/Users/dariofreire/MyDir/projs/diskettes/lp1960-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 6)), (0, _importCss3.default)('src/pages/Intro.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/Intro.jsx');
  },
  resolve: function resolve() {
    return /*require.resolve*/(6);
  },
  chunkName: function chunkName() {
    return 'src-pages-Intro.jsx';
  }
}), universalOptions);
var t_2 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/pages/Images.jsx',
  file: '/Users/dariofreire/MyDir/projs/diskettes/lp1960-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 8)), (0, _importCss3.default)('src/pages/Images.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/Images.jsx');
  },
  resolve: function resolve() {
    return /*require.resolve*/(8);
  },
  chunkName: function chunkName() {
    return 'src-pages-Images.jsx';
  }
}), universalOptions);
var t_3 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/pages/Contacto.jsx',
  file: '/Users/dariofreire/MyDir/projs/diskettes/lp1960-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 9)), (0, _importCss3.default)('src/pages/Contacto.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/Contacto.jsx');
  },
  resolve: function resolve() {
    return /*require.resolve*/(9);
  },
  chunkName: function chunkName() {
    return 'src-pages-Contacto.jsx';
  }
}), universalOptions);
var t_4 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  ...
  file: '/Users/dariofreire/MyDir/projs/diskettes/lp1960-website/dist/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 10)), (0, _importCss3.default)('src/pages/404.jsx', {
      disableWarnings: true
    })]).then(function (proms) {
      return proms[0];
    });
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/pages/404.jsx');
  },
  resolve: function resolve() {
...
//# sourceMappingURL=static.a959c1d8.js.map